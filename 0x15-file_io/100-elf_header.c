 ...
 * @e_ident: array having the ELF magic numbers.
 *
...
/**
 * print_magic - Prints the magic no of an ELF header.
 * @e_ident: array containing the ELF magic no
 *
 ...
 * @e_ident: array having ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
...
/**
 * print_abi - Prints ABI type of ELF header.
 * @e_ident: array having ELF version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - ELF header print type
 * @e_type: ELF type.
 * @e_ident: array that has ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * main - Tells what is in ELF header
 * @argc: no of arguments
 * @argv: array of arguments.
 *
 * Return: 0 on success.
 *
 * Description: when it is not ELF File or
 *              the function is wrong - exit code 98.
 */
